...
TString FileName1()
{
  TString f1="/home/xiongxa/ML_reweighting/DATA/EtaPi0Pi0/Final/DIY_after_final.root";
  return f1;
}
TString FileName2()
{
  TString f2="/home/xiongxa/ML_reweighting/hep_ml/Reweight_etapipi/DIY/Sampling/sample.root";
  return f2;
}
TString FileName3()
{
  TString f3="/home/xiongxa/ML_reweighting/DATA/EtaPi0Pi0/Final/DIY_after_final.root";
  return f3;
}
TString CutName1()
{
...
double max(double a,double b,double c)
{
  ...
  double maxup2 =c>maxup1?c:maxup1;
  return maxup2;
}
void plot3(TString name,const char *namex,const char *namey,int Nbin,double low,double up)
{
   ...
   //incl->Scale(data->Integral()/incl->Integral());
   ...
   leg->AddEntry(data,"DIY_MC","p");
   leg->AddEntry(incl,"ML_MC","l");
   ...
   pt->SetTextAlign(10);
	 pt->SetTextSize(0.06);
	 //pt->AddText("J/#psi->#gamma#eta'#eta#eta (#eta'->#eta#pi^{+}#pi^{-},#eta->#gamma#gamma)");
   pt->Draw();
...
void Comparasion_comb()
{
   ...
   plot3("Metapi01","M(#eta#pi^{0}_{1})","Events/(GeV/c^{2})",55,0.5,2.5);
   //plot3("Metapi02","M(#eta#pi^{0}_{2})","Events/(GeV/c^{2})",55,0.5,2.5);
   //plot3("Mpi01pi02","M(#pi^{0}_{1}#pi^{0}_{2})","Events/(GeV/c^{2})",55,0,2.5);
   //plot3("Metapi01pi02","M(#eta#pi^{0}#pi^{0})","Events/(GeV/c^{2})",55,2,2.8);
   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
