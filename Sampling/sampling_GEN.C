  ...
  while(!amp.eof())
{
  ...
  TFile *nin = new TFile("/home/xiongxa/ML_reweighting/DATA/EtaPi0Pi0/Final/MC_cut_final.root");
  TTree *ntuple = (TTree *) nin->Get("final");

  TFile *out = new TFile("sample9.root","recreate");
